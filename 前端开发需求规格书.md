...
### 1.2 项目背景
平台的核心目标是**"筹集"AI视频的制作时长与创意**。项目发起人（导演）提出创意蓝图，吸引参与者（美术）和参与者（创作者）加入，共同完成AI视频作品。
...
| **支持者 (Backer)** | **关注者 / 参与者 / 参与者** | 用户可以关注项目，或以更深度的方式参与项目 |
...
#### 2.2.2 参与者 (Collaborator)
- **职责**: 项目的"核心美术师"
- **标识**: 特殊角色标签

#### 2.2.3 参与者 (Worker Bee)
- **职责**: 项目的"算力支持者"
- **标识**: 参与者角色标签，主要在外部群组工作
